...
CREATE TABLE `tbl_filme` (
  ...
  `nome_original` varchar(45) DEFAULT NULL,
...
CREATE TABLE `tbl_filme_ator` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`),
  KEY `FK_ator_filme_ator` (`id_ator`),
  KEY `FK_filme_filme_ator` (`id_filme`),
  CONSTRAINT `FK_ator_filme_ator` FOREIGN KEY (`id_ator`) REFERENCES `tbl_ator` (`id`),
  CONSTRAINT `FK_filme_filme_ator` FOREIGN KEY (`id_filme`) REFERENCES `tbl_filme` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_filme_diretor` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`),
  KEY `FK_filme_filme_diretor` (`id_filme`),
  KEY `FK_diretor_filme_diretor` (`id_diretor`),
  CONSTRAINT `FK_diretor_filme_diretor` FOREIGN KEY (`id_diretor`) REFERENCES `tbl_diretor` (`id`),
  CONSTRAINT `FK_filme_filme_diretor` FOREIGN KEY (`id_filme`) REFERENCES `tbl_filme` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-11-01  7:36:24
